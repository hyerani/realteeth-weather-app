  ...
  if (!searchQuery.trim()) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">장소를 검색하여 날씨를 확인하세요</p>
        <p className="text-sm text-gray-400 mt-2">예: 서울, 강남구, 삼성동</p>
      </div>
    )
  }
  ...
  if (results.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-gray-500">'{searchQuery}'에 대한 결과를 찾을 수 없습니다</p>
        <p className="text-xs text-gray-400 mt-3">다른 검색어를 입력해보세요</p>
      </div>
    )
  }
  ...
  return (
    <div>
      <div className="mb-3 text-sm text-gray-500">
        <span className="font-medium text-gray-700">{results.length}개</span>의 장소를 찾았습니다
      </div>
